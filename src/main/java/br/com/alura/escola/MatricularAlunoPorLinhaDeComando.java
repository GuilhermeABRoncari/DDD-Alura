...
import br.com.alura.escola.gameficacao.aplicacao.GeradorDeSeloAlunoNovato;
...
public class MatricularAlunoPorLinhaDeComando {
	...
	public static void main(String[] args) {
		...
		publicadorDeEventos.adicionar(new GeradorDeSeloAlunoNovato(new RepositorioDeSelosEmMemoria()));
